...
import com.project.core.services.ComponentsInfoService;
import com.project.core.utils.ResolverUtil;

@Component(immediate = true, service = ComponentsInfoService.class, name = "com.project.core.services.ComponentsInfo", configurationPid = "com.aem.geeks.core.services.impl.ComponentsInfoImpl",
		property = {
		"service.vendor=Advance AEM - Project",
		"service.description=Advance AEM Training" }, configurationPolicy = ConfigurationPolicy.OPTIONAL)
